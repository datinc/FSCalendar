...
- (void)configureCell:(FSCalendarHeaderCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 2020-11-14 jcross: commenting out the below warning, as it produces noise for a problem in third party code.
    // This calendar library is included directly (not using a Git Sub-Module or CocoaPods).
    // A newer version is available, without this warning, from: https://github.com/WenchaoD/FSCalendar
    //#warning("The value stored to text is never read.")
